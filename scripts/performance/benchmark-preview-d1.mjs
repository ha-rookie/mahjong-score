...
const run=(sql)=>{
  ...
  const raw=execFileSync(npx,["wrangler","d1","execute","DB","--remote","--preview","--json","--command",sql],{
...
const lines=[
  ...
  "",
  "Preview D1 / 3 samples per case. Target: median <= 1000ms; repeated > 2000ms is a failure signal.",
  "",
  ...
  "",
  "CLI wall time includes Wrangler startup/network overhead and is recorded separately from D1 server duration."
];
