...
function App() {
  ...
  const scoreOutOfRange=entered.some(x=>Math.abs(x.value??0)>GAME_SCORE_ABS_MAX);const canCalculate=participantIds.length>=3&&!invalid&&!scoreOutOfRange&&entered.length===participantIds.length-1;
