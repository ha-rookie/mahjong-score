...
type View = "home" | "session-setup" | "results" | "history" | "performance" | "members" | "groups";
...
function App() {
  ...
  const canDeleteSession=Boolean(group&&appAuth&&(appAuth.user.systemRole==="admin"||appAuth.memberships.some(m=>m.groupId===group.id&&m.role==="group_admin")));
