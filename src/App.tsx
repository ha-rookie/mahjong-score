...
function App() {
  ...
  const openSessionSetup=()=>{
    if(group){setSessionStartingPoints(group.startingPoints);setSessionReturnPoints(group.returnPoints);setSessionChipRate(group.chipRate);}setShowSessionRuleOverride(false);
  ...
  const openRuleSettings=()=>{if(!group)return;setRuleStartingPoints(group.startingPoints);setRuleReturnPoints(group.returnPoints);setRuleChipRate(group.chipRate);setErrorMessage(null);setView("rules");};
