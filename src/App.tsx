  ...
  return <div className="app-shell">
    ...
    <main className="page">
      ...
      activeSession?<section className="score-session">
        ...
        <div className="game-tag-buttons" role="group" aria-label="半荘タグ"><button type="button" className={gameTagType==="yakuman"?"tag-toggle tag-toggle--active":"tag-toggle"} aria-pressed={gameTagType==="yakuman"} onClick={()=>setGameTagType(current=>current==="yakuman"?"":"yakuman")}>役満</button><button type="button" className={gameTagType==="double-yakuman"?"tag-toggle tag-toggle--active":"tag-toggle"} aria-pressed={gameTagType==="double-yakuman"} onClick={()=>setGameTagType(current=>current==="double-yakuman"?"":"double-yakuman")}>ダブル役満</button></div>
